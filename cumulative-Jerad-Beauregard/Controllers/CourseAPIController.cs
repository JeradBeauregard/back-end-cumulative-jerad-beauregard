...
namespace cumulative_Jerad_Beauregard.Controllers
{
	...
	public class CourseAPIController : ControllerBase
	{
		...
		public int UpdateCourse(int id, Course UpdatedCourse)
		{
			string query = "UPDATE courses SET coursecode = @ccode, teacherid = @tid, startdate = @start, finishdate = @finish, coursename = @name  WHERE courseid = @id";
			...
			using (MySqlConnection Connection = _context.AccessDatabase())
			{
				...
				MySqlCommand Command = Connection.CreateCommand();
				Command.CommandText = query;
				Command.Parameters.AddWithValue("@ccode", UpdatedCourse.CourseCode);
				Command.Parameters.AddWithValue("@tid", UpdatedCourse.TeacherId);
				Command.Parameters.AddWithValue("@start", UpdatedCourse.StartDate);
				Command.Parameters.AddWithValue("@finish", UpdatedCourse.FinishDate);
				Command.Parameters.AddWithValue("@name", UpdatedCourse.CourseName);
				Command.Parameters.AddWithValue("@id", id);
